...
// EXERCISE DBUS: Qt DBus headers are needed by this class
#ifdef Q_WS_MAEMO_5
...
// EXERCISE STORAGELOC:
// No need to have customized Qt code for Maemo here. Maemo uses
// specific file locations, but this is handled by Qt for Maemo port.
...
// EXERCISE DBUS:
// The following code performs minimizing Maemo application by using DBus.
