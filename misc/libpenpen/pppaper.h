...
<title>~benlau/penpen/trunk : contents of src/libpenpen/pppaper.h at revision 78</title>
...
/<a href="http://bazaar.launchpad.net/%7Ebenlau/penpen/trunk/files/78?file_id=src-20100614163637-a9u616hzyeh125l5-1">src</a>/<a href="http://bazaar.launchpad.net/%7Ebenlau/penpen/trunk/files/78?file_id=libpenpen-20100725033312-lcpnhscm51x8wpur-1">libpenpen</a>/pppaper.h
...
<li>
<a href="http://bazaar.launchpad.net/%7Ebenlau/penpen/trunk/changes?filter_file_id=pppaper.h-20100725042013-828juut0ftqt4kgp-2">view changes to this file</a>
</li>
<li id="last">
<a href="http://bazaar.launchpad.net/%7Ebenlau/penpen/trunk/download/head%3A/pppaper.h-20100725042013-828juut0ftqt4kgp-2/pppaper.h">download file</a>
</li>
</ul>
<div class="annotate">
<table id="logentries">
...
<td class="annoCont"><pre><span class="pyg-cp">#ifndef PPPAPER_H</span></pre></td>
</tr><tr class="blueRow1">
<td class="annoLine"><a id="L6" href="#L6">6</a></td>
<td class="annoRev">

</td>
<td class="annoCont"><pre><span class="pyg-cp">#define PPPAPER_H</span></pre></td>
</tr><tr class="blueRow1">
...
<td class="annoCont"><pre><span class="pyg-c1">/// A QGraphicsItem for handwriting</span></pre></td>
</tr><tr class="blueRow0">
...
<td class="annoCont"><pre><span class="pyg-n">class</span><span class="pyg-"> </span><span class="pyg-n">PPPaper</span><span class="pyg-"> </span><span class="pyg-o">:</span><span class="pyg-"> </span><span class="pyg-n">public</span><span class="pyg-"> </span><span class="pyg-n">QGraphicsObject</span><span class="pyg-"></span></pre></td>
</tr><tr class="blueRow0">
...
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-n">explicit</span><span class="pyg-"> </span><span class="pyg-n">PPPaper</span><span class="pyg-p">(</span><span class="pyg-n">QGraphicsItem</span><span class="pyg-"> </span><span class="pyg-o">*</span><span class="pyg-n">parent</span><span class="pyg-"> </span><span class="pyg-o">=</span><span class="pyg-"> </span><span class="pyg-mi">0</span><span class="pyg-p">);</span><span class="pyg-"></span></pre></td>
</tr><tr class="blueRow0">
...
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-c1">/// Get the drawing area of the paper on scene</span></pre></td>
</tr><tr class="blueRow0">
<td class="annoLine"><a id="L24" href="#L24">24</a></td>
<td class="annoRev">

</td>
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-n">QRect</span><span class="pyg-"> </span><span class="pyg-n">rect</span><span class="pyg-p">()</span><span class="pyg-"> </span><span class="pyg-k">const</span><span class="pyg-p">;</span><span class="pyg-"></span></pre></td>
</tr><tr class="blueRow0">
...
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-c1">/// Set the drawing area of the paper on scene</span></pre></td>
</tr><tr class="blueRow0">
<td class="annoLine"><a id="L27" href="#L27">27</a></td>
<td class="annoRev">

</td>
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-kt">void</span><span class="pyg-"> </span><span class="pyg-n">setRect</span><span class="pyg-p">(</span><span class="pyg-n">QRect</span><span class="pyg-"> </span><span class="pyg-n">val</span><span class="pyg-p">);</span><span class="pyg-"></span></pre></td>
</tr><tr class="blueRow0">
...
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-n">bool</span><span class="pyg-"> </span><span class="pyg-n">dirty</span><span class="pyg-p">();</span><span class="pyg-"></span></pre></td>
</tr><tr class="blueRow0">
...
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-c1">/// Set the background of paper</span></pre></td>
</tr><tr class="blueRow1">
<td class="annoLine"><a id="L32" href="#L32">32</a></td>
<td class="annoRev">
<a href="http://bazaar.launchpad.net/%7Ebenlau/penpen/trunk/revision/65" title="65 by Ben Lau, on 03 Aug 2010 13:03 (2010-08-03 13:03:45)">65</a>
</td>
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-kt">void</span><span class="pyg-"> </span><span class="pyg-n">setBackground</span><span class="pyg-p">(</span><span class="pyg-n">PPBackground</span><span class="pyg-"> </span><span class="pyg-n">val</span><span class="pyg-p">);</span><span class="pyg-"></span></pre></td>
</tr><tr class="blueRow0">
...
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-n">PPBackground</span><span class="pyg-"> </span><span class="pyg-n">background</span><span class="pyg-p">();</span><span class="pyg-"></span></pre></td>
</tr><tr class="blueRow0">
...
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-c1">/// The next ID to be assigned for stroke</span></pre></td>
</tr><tr class="blueRow1">
<td class="annoLine"><a id="L37" href="#L37">37</a></td>
<td class="annoRev">

</td>
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-kt">int</span><span class="pyg-"> </span><span class="pyg-n">nextId</span><span class="pyg-p">();</span><span class="pyg-"></span></pre></td>
</tr><tr class="blueRow1">
...
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-kt">void</span><span class="pyg-"> </span><span class="pyg-n">setDirty</span><span class="pyg-p">(</span><span class="pyg-n">bool</span><span class="pyg-"> </span><span class="pyg-n">val</span><span class="pyg-"> </span><span class="pyg-o">=</span><span class="pyg-"> </span><span class="pyg-nb">true</span><span class="pyg-p">);</span><span class="pyg-"></span></pre></td>
</tr><tr class="blueRow0">
...
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-c1">/// clear the content and reset to initial status</span></pre></td>
</tr><tr class="blueRow1">
<td class="annoLine"><a id="L45" href="#L45">45</a></td>
<td class="annoRev">

</td>
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-k">virtual</span><span class="pyg-"> </span><span class="pyg-kt">void</span><span class="pyg-"> </span><span class="pyg-n">clear</span><span class="pyg-p">();</span><span class="pyg-"></span></pre></td>
</tr><tr class="blueRow1">
...
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-n">QRect</span><span class="pyg-"> </span><span class="pyg-n">m_rect</span><span class="pyg-p">;</span><span class="pyg-"></span></pre></td>
</tr><tr class="blueRow1">
<td class="annoLine"><a id="L52" href="#L52">52</a></td>
<td class="annoRev">

</td>
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-n">bool</span><span class="pyg-"> </span><span class="pyg-n">m_dirty</span><span class="pyg-p">;</span><span class="pyg-"></span></pre></td>
</tr><tr class="blueRow0">
<td class="annoLine"><a id="L53" href="#L53">53</a></td>
<td class="annoRev">
<a href="http://bazaar.launchpad.net/%7Ebenlau/penpen/trunk/revision/55" title="55 by Ben Lau, on 28 Jul 2010 12:20 (2010-07-28 12:20:29)">55</a>
</td>
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-kt">int</span><span class="pyg-"> </span><span class="pyg-n">m_nextId</span><span class="pyg-p">;</span><span class="pyg-"></span></pre></td>
</tr><tr class="blueRow1">
...
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-n">PPBackground</span><span class="pyg-"> </span><span class="pyg-n">m_background</span><span class="pyg-p">;</span><span class="pyg-"></span></pre></td>
</tr><tr class="blueRow1">
...
<td class="annoCont"><pre><span class="pyg-cp">#endif </span><span class="pyg-c1">// PPPAPER_H</span></pre></td>
</tr>
</table>
</div>
</div>
