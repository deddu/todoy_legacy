...
<title>~benlau/penpen/trunk : contents of src/libpenpen/pppen.h at revision 78</title>
...
/<a href="http://bazaar.launchpad.net/%7Ebenlau/penpen/trunk/files/78?file_id=src-20100614163637-a9u616hzyeh125l5-1">src</a>/<a href="http://bazaar.launchpad.net/%7Ebenlau/penpen/trunk/files/78?file_id=libpenpen-20100725033312-lcpnhscm51x8wpur-1">libpenpen</a>/pppen.h
...
<li>
<a href="http://bazaar.launchpad.net/%7Ebenlau/penpen/trunk/changes?filter_file_id=strokerecorder.h-20100614163637-a9u616hzyeh125l5-33">view changes to this file</a>
</li>
<li id="last">
<a href="http://bazaar.launchpad.net/%7Ebenlau/penpen/trunk/download/head%3A/strokerecorder.h-20100614163637-a9u616hzyeh125l5-33/pppen.h">download file</a>
</li>
</ul>
<div class="annotate">
<table id="logentries">
...
<td class="annoCont"><pre><span class="pyg-cp">#ifndef PPPEN_H</span></pre></td>
</tr><tr class="blueRow1">
<td class="annoLine"><a id="L2" href="#L2">2</a></td>
<td class="annoRev">

</td>
<td class="annoCont"><pre><span class="pyg-cp">#define PPPEN_H</span></pre></td>
...
<td class="annoCont"><pre><span class="pyg-c1">/// Pen drawing tool on QGraphicsItem</span></pre></td>
</tr><tr class="blueRow0">
...
<td class="annoCont"><pre><span class="pyg-n">class</span><span class="pyg-"> </span><span class="pyg-n">PPPen</span><span class="pyg-"> </span><span class="pyg-o">:</span><span class="pyg-"> </span><span class="pyg-n">public</span><span class="pyg-"> </span><span class="pyg-n">QGraphicsObject</span><span class="pyg-"></span></pre></td>
</tr><tr class="blueRow1">
...
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-n">explicit</span><span class="pyg-"> </span><span class="pyg-n">PPPen</span><span class="pyg-p">(</span><span class="pyg-n">QGraphicsItem</span><span class="pyg-"> </span><span class="pyg-o">*</span><span class="pyg-n">parent</span><span class="pyg-"> </span><span class="pyg-o">=</span><span class="pyg-"> </span><span class="pyg-mi">0</span><span class="pyg-p">);</span><span class="pyg-"></span></pre></td>
</tr><tr class="blueRow1">
...
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-c1">/// Start to draw on graphics item</span></pre></td>
</tr><tr class="blueRow0">
<td class="annoLine"><a id="L19" href="#L19">19</a></td>
<td class="annoRev">

</td>
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-kt">void</span><span class="pyg-"> </span><span class="pyg-n">start</span><span class="pyg-p">(</span><span class="pyg-n">QGraphicsItem</span><span class="pyg-o">*</span><span class="pyg-"> </span><span class="pyg-n">canvas</span><span class="pyg-p">);</span><span class="pyg-"></span></pre></td>
</tr><tr class="blueRow1">
...
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-c1">/// Stop the capture. It won&#39;t emit captured signal</span></pre></td>
</tr><tr class="blueRow1">
<td class="annoLine"><a id="L22" href="#L22">22</a></td>
<td class="annoRev">

</td>
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-kt">void</span><span class="pyg-"> </span><span class="pyg-n">stop</span><span class="pyg-p">();</span><span class="pyg-"></span></pre></td>
</tr><tr class="blueRow1">
...
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-c1">/// Set the pen style directly. It will override the color and line width</span></pre></td>
</tr><tr class="blueRow1">
<td class="annoLine"><a id="L25" href="#L25">25</a></td>
<td class="annoRev">
<a href="http://bazaar.launchpad.net/%7Ebenlau/penpen/trunk/revision/1" title="1 by Ben Lau, on 14 Jun 2010 16:36 (2010-06-14 16:36:55)">1</a>
</td>
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-kt">void</span><span class="pyg-"> </span><span class="pyg-n">setPen</span><span class="pyg-p">(</span><span class="pyg-n">QPen</span><span class="pyg-"> </span><span class="pyg-o">&amp;</span><span class="pyg-n">pen</span><span class="pyg-p">);</span><span class="pyg-"></span></pre></td>
</tr><tr class="blueRow1">
...
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-kt">void</span><span class="pyg-"> </span><span class="pyg-n">setColor</span><span class="pyg-p">(</span><span class="pyg-n">QColor</span><span class="pyg-"> </span><span class="pyg-n">color</span><span class="pyg-p">);</span><span class="pyg-"></span></pre></td>
</tr><tr class="blueRow0">
...
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-kt">void</span><span class="pyg-"> </span><span class="pyg-n">setWidth</span><span class="pyg-p">(</span><span class="pyg-kt">int</span><span class="pyg-"> </span><span class="pyg-n">val</span><span class="pyg-p">);</span><span class="pyg-"></span></pre></td>
</tr><tr class="blueRow1">
<td class="annoLine"><a id="L32" href="#L32">32</a></td>
<td class="annoRev">

</td>
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-kt">int</span><span class="pyg-"> </span><span class="pyg-n">width</span><span class="pyg-p">();</span><span class="pyg-"></span></pre></td>
</tr><tr class="blueRow1">
...
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-c1">/// The signal is emitted when a stroke is added.</span></pre></td>
</tr><tr class="blueRow1">
<td class="annoLine"><a id="L36" href="#L36">36</a></td>
<td class="annoRev">

</td>
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-kt">void</span><span class="pyg-"> </span><span class="pyg-n">added</span><span class="pyg-p">();</span><span class="pyg-"></span></pre></td>
</tr><tr class="blueRow0">
...
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-k">virtual</span><span class="pyg-"> </span><span class="pyg-n">bool</span><span class="pyg-"> </span><span class="pyg-n">sceneEventFilter</span><span class="pyg-"> </span><span class="pyg-p">(</span><span class="pyg-"> </span><span class="pyg-n">QGraphicsItem</span><span class="pyg-"> </span><span class="pyg-o">*</span><span class="pyg-"> </span><span class="pyg-n">watched</span><span class="pyg-p">,</span><span class="pyg-"> </span><span class="pyg-n">QEvent</span><span class="pyg-"> </span><span class="pyg-o">*</span><span class="pyg-"> </span><span class="pyg-n">event</span><span class="pyg-p">);</span><span class="pyg-"></span></pre></td>
</tr><tr class="blueRow0">
...
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-n">QGraphicsItem</span><span class="pyg-"> </span><span class="pyg-o">*</span><span class="pyg-n">canvas</span><span class="pyg-p">;</span><span class="pyg-"></span></pre></td>
</tr><tr class="blueRow0">
...
<td class="annoCont"><pre><span class="pyg-">    </span><span class="pyg-n">PPGraphicsStroke</span><span class="pyg-"> </span><span class="pyg-o">*</span><span class="pyg-n">stroke</span><span class="pyg-p">;</span><span class="pyg-"></span></pre></td>
</tr><tr class="blueRow0">
...
<td class="annoCont"><pre><span class="pyg-cp">#endif </span><span class="pyg-c1">// PPPEN_H</span></pre></td>
</tr>
</table>
</div>
</div>
